...
@section('content')
    <form action="{{ route('cms.properties.update', $property) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="bg-white border border-gray-100 rounded-3xl p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div class="space-y-2">
                    ...
                    <input type="text" name="title" value="{{ old('title', $property->title) }}" required placeholder="e.g., 3 Bedroom House in Area 10" class="w-full bg-gray-100 rounded-2xl py-4 px-5 focus:ring-2 focus:ring-primary focus:bg-white border border-transparent focus:border-primary/20">
                    @error('title') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                </div>
                <div class="space-y-2">
                    <label class="text-sm font-semibold tracking-wider">Property Type</label>
                    <input type="text" name="type" value="{{ old('type', $property->type) }}" required placeholder="e.g., House, Apartment, Plot" class="w-full bg-gray-100 rounded-2xl py-4 px-5 focus:ring-2 focus:ring-primary focus:bg-white border border-transparent focus:border-primary/20">
                    @error('type') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                </div>
                <div class="space-y-2">
                    <label class="text-sm font-semibold tracking-wider">Price (Numerical)</label>
                    <input type="number" name="price" value="{{ old('price', (int)$property->price) }}" required placeholder="e.g., 120000000" class="w-full bg-gray-100 rounded-2xl py-4 px-5 focus:ring-2 focus:ring-primary focus:bg-white border border-transparent focus:border-primary/20">
                ...
                <div class="space-y-2">
                    ...
                    <select name="currency" class="w-full bg-gray-100 rounded-2xl py-4 px-5 focus:ring-2 focus:ring-primary focus:bg-white border border-transparent focus:border-primary/20 cursor-pointer">
                        <option value="MWK" {{ old('currency', $property->currency) == 'MWK' ? 'selected' : '' }}>MWK</option>
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="location" value="{{ old('location', $property->location) }}" required placeholder="e.g., Lilongwe, Area 10" class="w-full bg-gray-100 rounded-2xl py-4 px-5 focus:ring-2 focus:ring-primary focus:bg-white border border-transparent focus:border-primary/20">
                ...
                <div class="space-y-2 md:col-span-2">
                    ...
                    <textarea name="description" rows="5" required placeholder="Write a clear description of the property..." class="w-full bg-gray-100 rounded-2xl py-4 px-5 focus:ring-2 focus:ring-primary focus:bg-white border border-transparent focus:border-primary/20">{{ old('description', $property->description) }}</textarea>
        ...
        <div class="bg-white border border-gray-100 rounded-3xl p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                <div class="space-y-2">
                    ...
                    <input type="number" name="bedrooms" value="{{ old('bedrooms', $property->bedrooms) }}" min="0" placeholder="0" class="w-full bg-gray-100 rounded-2xl py-4 px-5 focus:ring-2 focus:ring-primary focus:bg-white border border-transparent focus:border-primary/20">
                </div>
                <div class="space-y-2">
                    <label class="text-sm font-semibold tracking-wider">Bathrooms</label>
                    <input type="number" name="bathrooms" value="{{ old('bathrooms', $property->bathrooms) }}" min="0" placeholder="0" class="w-full bg-gray-100 rounded-2xl py-4 px-5 focus:ring-2 focus:ring-primary focus:bg-white border border-transparent focus:border-primary/20">
                </div>
                <div class="space-y-2">
                    <label class="text-sm font-semibold tracking-wider">Land Size</label>
                    <input type="text" name="land_size" value="{{ old('land_size', $property->land_size) }}" placeholder="e.g., 500 sqm, 0.25 acre" class="w-full bg-gray-100 rounded-2xl py-4 px-5 focus:ring-2 focus:ring-primary focus:bg-white border border-transparent focus:border-primary/20">
                </div>
                <div class="space-y-2">
                    <label class="text-sm font-semibold tracking-wider">Parking Spaces</label>
                    <input type="number" name="parking_spaces" value="{{ old('parking_spaces', $property->parking_spaces) }}" min="0" placeholder="0" class="w-full bg-gray-100 rounded-2xl py-4 px-5 focus:ring-2 focus:ring-primary focus:bg-white border border-transparent focus:border-primary/20">
                </div>
            </div>
        </div>
        ...
        <div class="bg-white border border-gray-100 rounded-3xl p-6">
            ...
            <p class="text-sm text-brand-black/60 mb-6">Update images for the property listing.</p>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="space-y-4">
                    <label class="text-sm font-semibold tracking-wider block">Featured Image (Optional)</label>
                    @if($property->featured_image)
                        <div class="mb-4 w-32 h-32 rounded-2xl overflow-hidden border border-gray-200">
                    ...
                    <div class="relative group">
                        ...
                        <div class="border-2 border-dashed border-gray-200 rounded-3xl p-8 text-center bg-gray-50 group-hover:bg-gray-100 transition">
                            ...
                            <p class="text-sm font-semibold">Replace Featured Image</p>
                        </div>
                    </div>
                ...
                <div class="space-y-4">
                    ...
                    @if($property->gallery)
                        <div class="grid grid-cols-4 gap-2 mb-4">
                            @foreach($property->gallery as $image)
                                <div class="w-full aspect-square rounded-xl overflow-hidden border border-gray-200">
                    ...
                    <div class="relative group">
                        ...
                        <div class="border-2 border-dashed border-gray-200 rounded-3xl p-8 text-center bg-gray-50 group-hover:bg-gray-100 transition">
                            ...
                            <p class="text-sm font-semibold">Add More Gallery Images</p>
                        </div>
                    </div>
                </div>
            </div>
