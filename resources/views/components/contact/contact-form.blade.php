{{-- [Component: contact/contact-form] Contact form placeholder layout --}}
<section id="contact-form" class="py-16 px-6 bg-brand-white">
    <div class="max-w-5xl mx-auto rounded-[2rem] bg-complementary p-10">
        <form class="grid gap-6">
            ...
            <label class="block">
                <span class="font-body text-sm text-brand-black/75">{{-- Message label --}}</span>
                <textarea
