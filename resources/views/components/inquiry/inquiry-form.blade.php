...
<section id="inquiry-form" class="py-6 h-full md:py-12 px-4 md:px-6 min-h-[70vh] flex md:justify-center md:items-center" x-data="inquiryFlow()">
    <div class="w-full max-w-5xl transition-all duration-500"
         :class="step === 5 ? 'bg-brand-black rounded-[1.5rem] p-8 md:p-12 text-white overflow-hidden relative min-h-[80vh] flex items-center' : 'bg-brand-white rounded-[1.5rem] p-6 md:p-12 border border-gray-100 flex-grow'">
        ...
        <div class="w-full relative z-10">
            ...
            <form @submit.prevent="submitForm" class="flex flex-col min-h-full">
                ...
                <div x-show="step === 1" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-x-8" x-transition:enter-end="opacity-100 translate-x-0">
                    <h2 class="text-2xl md:text-5xl font-heading text-brand-black mb-6 md:mb-8 uppercase tracking-tight">How Can We Assist You?</h2>
                    <div class="space-y-6">
                        <div class="space-y-2">
                            <label class="text-xs font-bold uppercase tracking-widest text-gray-400">Service Needed</label>
                            <select x-model="formData.service" @change="resetServiceFields" class="w-full bg-gray-100 rounded-xl md:rounded-2xl py-4 md:py-5 px-5 md:px-6 text-brand-black font-semibold focus:ring-2 focus:ring-primary focus:bg-white cursor-pointer border-none text-base md:text-lg appearance-none bg-[length:20px_20px] bg-[right_1.25rem_center] bg-no-repeat" style="background-image: url('data:image/svg+xml;utf8,<svg xmlns=%22http://www.w3.org/2000/svg%22 width=%2224%22 height=%2224%22 viewBox=%220 0 24 24%22 fill=%22none%22 stroke=%22%23222222%22 stroke-width=%222%22 stroke-linecap=%22round%22 stroke-linejoin=%22round%22><path d=%22m6 9 6 6 6-6%22/></svg>');">
                ...
                <div x-show="step === 2" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-x-8" x-transition:enter-end="opacity-100 translate-x-0">
                    <h2 class="text-3xl md:text-5xl font-heading text-brand-black mb-6 md:mb-8 uppercase tracking-tight">Tell Us About Yourself</h2>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8">
                        <div class="space-y-1.5">
                            <label class="text-xs font-bold uppercase tracking-widest text-gray-400">Full Name</label>
                            <input type="text" x-model="formData.name" placeholder="Enter your full name" class="w-full bg-gray-100 rounded-xl md:rounded-2xl py-4 md:py-5 px-5 md:px-6 text-brand-black font-semibold focus:ring-2 focus:ring-primary focus:bg-white border-none text-base md:text-lg">
                        </div>
                        <div class="space-y-1.5">
                            <label class="text-xs font-bold uppercase tracking-widest text-gray-400">Phone Number</label>
                            <input type="tel" x-model="formData.phone" placeholder="Enter your phone number" class="w-full bg-gray-100 rounded-xl md:rounded-2xl py-4 md:py-5 px-5 md:px-6 text-brand-black font-semibold focus:ring-2 focus:ring-primary focus:bg-white border-none text-base md:text-lg">
                        </div>
                        <div class="space-y-1.5">
                            <label class="text-xs font-bold uppercase tracking-widest text-gray-400">Email Address</label>
                            <input type="email" x-model="formData.email" placeholder="Enter your email address" class="w-full bg-gray-100 rounded-xl md:rounded-2xl py-4 md:py-5 px-5 md:px-6 text-brand-black font-semibold focus:ring-2 focus:ring-primary focus:bg-white border-none text-base md:text-lg">
                        </div>
                        <div class="space-y-1.5">
                            <label class="text-xs font-bold uppercase tracking-widest text-gray-400">Contact Method</label>
                            <select x-model="formData.contactMethod" class="w-full bg-gray-100 rounded-xl md:rounded-2xl py-4 md:py-5 px-5 md:px-6 text-brand-black font-semibold focus:ring-2 focus:ring-primary focus:bg-white cursor-pointer border-none text-base md:text-lg appearance-none bg-[length:18px_18px] bg-[right_1.25rem_center] bg-no-repeat" style="background-image: url('data:image/svg+xml;utf8,<svg xmlns=%22http://www.w3.org/2000/svg%22 width=%2224%22 height=%2224%22 viewBox=%220 0 24 24%22 fill=%22none%22 stroke=%22%23222222%22 stroke-width=%222%22 stroke-linecap=%22round%22 stroke-linejoin=%22round%22><path d=%22m6 9 6 6 6-6%22/></svg>');">
                ...
                <div x-show="step === 3" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-x-8" x-transition:enter-end="opacity-100 translate-x-0">
                    <h2 class="text-3xl md:text-5xl font-heading text-brand-black mb-2 uppercase tracking-tight">Additional Details</h2>
                    <p class="mb-6 md:mb-8 text-sm md:text-lg text-gray-500 uppercase tracking-widest font-bold">Service: <span class="text-primary" x-text="formData.service"></span></p>

                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8">
                        {{-- Common Fields: Location --}}
                        <div class="space-y-1.5" x-show="formData.service !== 'General Consultation'">
                            <label class="text-xs font-bold uppercase tracking-widest text-gray-400" x-text="formData.service === 'Property Development' ? 'Project Location' : 'Property Location'"></label>
                            <input type="text" x-model="formData.location" :placeholder="'Enter location'" class="w-full bg-gray-100 rounded-xl md:rounded-2xl py-4 md:py-5 px-5 md:px-6 text-brand-black font-semibold focus:ring-2 focus:ring-primary focus:bg-white border-none text-base md:text-lg">
                        </div>
                        ...
                        <template x-if="formData.service === 'Property Valuation'">
                            <div class="space-y-1.5 flex flex-col gap-5 md:contents">
                                <div class="space-y-1.5">
                                    <label class="text-xs font-bold uppercase tracking-widest text-gray-400">Property Type</label>
                                    <select x-model="formData.propertyType" class="w-full bg-gray-100 rounded-xl md:rounded-2xl py-4 md:py-5 px-5 md:px-6 text-brand-black font-semibold focus:ring-2 focus:ring-primary focus:bg-white cursor-pointer border-none text-base md:text-lg appearance-none bg-[length:18px_18px] bg-[right_1.25rem_center] bg-no-repeat" style="background-image: url('data:image/svg+xml;utf8,<svg xmlns=%22http://www.w3.org/2000/svg%22 width=%2224%22 height=%2224%22 viewBox=%220 0 24 24%22 fill=%22none%22 stroke=%22%23222222%22 stroke-width=%222%22 stroke-linecap=%22round%22 stroke-linejoin=%22round%22><path d=%22m6 9 6 6 6-6%22/></svg>');">
                                ...
                                <div class="space-y-1.5">
                                    <label class="text-xs font-bold uppercase tracking-widest text-gray-400">Purpose of Valuation</label>
                                    <select x-model="formData.purposeOfValuation" class="w-full bg-gray-100 rounded-xl md:rounded-2xl py-4 md:py-5 px-5 md:px-6 text-brand-black font-semibold focus:ring-2 focus:ring-primary focus:bg-white cursor-pointer border-none text-base md:text-lg appearance-none bg-[length:18px_18px] bg-[right_1.25rem_center] bg-no-repeat" style="background-image: url('data:image/svg+xml;utf8,<svg xmlns=%22http://www.w3.org/2000/svg%22 width=%2224%22 height=%2224%22 viewBox=%220 0 24 24%22 fill=%22none%22 stroke=%22%23222222%22 stroke-width=%222%22 stroke-linecap=%22round%22 stroke-linejoin=%22round%22><path d=%22m6 9 6 6 6-6%22/></svg>');">
                                ...
                                <div class="space-y-1.5">
                                    <label class="text-xs font-bold uppercase tracking-widest text-gray-400">Estimated Size</label>
                                    <input type="text" x-model="formData.estimatedPropertySize" placeholder="e.g., 2000 sqm" class="w-full bg-gray-100 rounded-xl md:rounded-2xl py-4 md:py-5 px-5 md:px-6 text-brand-black font-semibold focus:ring-2 focus:ring-primary focus:bg-white border-none text-base md:text-lg">
                                </div>
                            </div>
                        </template>
                        ...
                        <template x-if="formData.service === 'Property Management'">
                            <div class="space-y-1.5 flex flex-col gap-5 md:contents">
                                <div class="space-y-1.5">
                                    <label class="text-xs font-bold uppercase tracking-widest text-gray-400">Management Needs</label>
                                    <select x-model="formData.managementNeeds" class="w-full bg-gray-100 rounded-xl md:rounded-2xl py-4 md:py-5 px-5 md:px-6 text-brand-black font-semibold focus:ring-2 focus:ring-primary focus:bg-white cursor-pointer border-none text-base md:text-lg appearance-none bg-[length:18px_18px] bg-[right_1.25rem_center] bg-no-repeat" style="background-image: url('data:image/svg+xml;utf8,<svg xmlns=%22http://www.w3.org/2000/svg%22 width=%2224%22 height=%2224%22 viewBox=%220 0 24 24%22 fill=%22none%22 stroke=%22%23222222%22 stroke-width=%222%22 stroke-linecap=%22round%22 stroke-linejoin=%22round%22><path d=%22m6 9 6 6 6-6%22/></svg>');">
                                ...
                                <div class="space-y-1.5">
                                    <label class="text-xs font-bold uppercase tracking-widest text-gray-400">Number of Properties</label>
                                    <input type="text" x-model="formData.numberOfProperties" placeholder="e.g., 1, 5, 10+" class="w-full bg-gray-100 rounded-xl md:rounded-2xl py-4 md:py-5 px-5 md:px-6 text-brand-black font-semibold focus:ring-2 focus:ring-primary focus:bg-white border-none text-base md:text-lg">
                                </div>
                            </div>
                        </template>
                        ...
                        <template x-if="formData.service === 'Sales & Letting'">
                            <div class="space-y-1.5 flex flex-col gap-5 md:contents">
                                <div class="space-y-1.5">
                                    <label class="text-xs font-bold uppercase tracking-widest text-gray-400">Inquiry Type</label>
                                    <select x-model="formData.inquiryType" class="w-full bg-gray-100 rounded-xl md:rounded-2xl py-4 md:py-5 px-5 md:px-6 text-brand-black font-semibold focus:ring-2 focus:ring-primary focus:bg-white cursor-pointer border-none text-base md:text-lg appearance-none bg-[length:18px_18px] bg-[right_1.25rem_center] bg-no-repeat" style="background-image: url('data:image/svg+xml;utf8,<svg xmlns=%22http://www.w3.org/2000/svg%22 width=%2224%22 height=%2224%22 viewBox=%220 0 24 24%22 fill=%22none%22 stroke=%22%23222222%22 stroke-width=%222%22 stroke-linecap=%22round%22 stroke-linejoin=%22round%22><path d=%22m6 9 6 6 6-6%22/></svg>');">
                                        <option value="">Select type</option>
                                ...
                                <div class="space-y-1.5">
                                    ...
                                    <input type="text" x-model="formData.budgetAskingPrice" placeholder="Enter budget/asking price" class="w-full bg-gray-100 rounded-xl md:rounded-2xl py-4 md:py-5 px-5 md:px-6 text-brand-black font-semibold focus:ring-2 focus:ring-primary focus:bg-white border-none text-base md:text-lg">
                                </div>
                            </div>
                        </template>
                        ...
                        <template x-if="formData.service === 'Property Development'">
                            <div class="space-y-1.5 flex flex-col gap-5 md:contents">
                                <div class="space-y-1.5">
                                    <label class="text-xs font-bold uppercase tracking-widest text-gray-400">Project Type</label>
                                    <select x-model="formData.projectType" class="w-full bg-gray-100 rounded-xl md:rounded-2xl py-4 md:py-5 px-5 md:px-6 text-brand-black font-semibold focus:ring-2 focus:ring-primary focus:bg-white cursor-pointer border-none text-base md:text-lg appearance-none bg-[length:18px_18px] bg-[right_1.25rem_center] bg-no-repeat" style="background-image: url('data:image/svg+xml;utf8,<svg xmlns=%22http://www.w3.org/2000/svg%22 width=%2224%22 height=%2224%22 viewBox=%220 0 24 24%22 fill=%22none%22 stroke=%22%23222222%22 stroke-width=%222%22 stroke-linecap=%22round%22 stroke-linejoin=%22round%22><path d=%22m6 9 6 6 6-6%22/></svg>');">
                                        <option value="">Select type</option>
                                        <option value="Residential">Residential</option>
                                        <option value="Commercial">Commercial</option>
                                ...
                                <div class="space-y-1.5">
                                    <label class="text-xs font-bold uppercase tracking-widest text-gray-400">Project Stage</label>
                                    <select x-model="formData.projectStage" class="w-full bg-gray-100 rounded-xl md:rounded-2xl py-4 md:py-5 px-5 md:px-6 text-brand-black font-semibold focus:ring-2 focus:ring-primary focus:bg-white cursor-pointer border-none text-base md:text-lg appearance-none bg-[length:18px_18px] bg-[right_1.25rem_center] bg-no-repeat" style="background-image: url('data:image/svg+xml;utf8,<svg xmlns=%22http://www.w3.org/2000/svg%22 width=%2224%22 height=%2224%22 viewBox=%220 0 24 24%22 fill=%22none%22 stroke=%22%23222222%22 stroke-width=%222%22 stroke-linecap=%22round%22 stroke-linejoin=%22round%22><path d=%22m6 9 6 6 6-6%22/></svg>');">
                        ...
                        <template x-if="formData.service === 'Title Deed Processing'">
                            <div class="space-y-1.5 flex flex-col gap-5 md:contents">
                                <div class="space-y-1.5">
                                    <label class="text-xs font-bold uppercase tracking-widest text-gray-400">Current Status</label>
                                    <input type="text" x-model="formData.currentStatus" placeholder="e.g., Pending review" class="w-full bg-gray-100 rounded-xl md:rounded-2xl py-4 md:py-5 px-5 md:px-6 text-brand-black font-semibold focus:ring-2 focus:ring-primary focus:bg-white border-none text-base md:text-lg">
                                </div>
                            </div>
                        </template>
                        ...
                        <template x-if="formData.service === 'General Consultation'">
                            <div class="space-y-1.5 flex flex-col gap-5 md:contents">
                                <div class="space-y-1.5">
                                    <label class="text-xs font-bold uppercase tracking-widest text-gray-400">Inquiry Topic</label>
                                    <input type="text" x-model="formData.inquiryTopic" placeholder="Enter topic" class="w-full bg-gray-100 rounded-xl md:rounded-2xl py-4 md:py-5 px-5 md:px-6 text-brand-black font-semibold focus:ring-2 focus:ring-primary focus:bg-white border-none text-base md:text-lg">
                                </div>
                                <div class="space-y-1.5">
                                    <label class="text-xs font-bold uppercase tracking-widest text-gray-400">Preferred Service</label>
                                    <select x-model="formData.preferredService" class="w-full bg-gray-100 rounded-xl md:rounded-2xl py-4 md:py-5 px-5 md:px-6 text-brand-black font-semibold focus:ring-2 focus:ring-primary focus:bg-white cursor-pointer border-none text-base md:text-lg appearance-none bg-[length:18px_18px] bg-[right_1.25rem_center] bg-no-repeat" style="background-image: url('data:image/svg+xml;utf8,<svg xmlns=%22http://www.w3.org/2000/svg%22 width=%2224%22 height=%2224%22 viewBox=%220 0 24 24%22 fill=%22none%22 stroke=%22%23222222%22 stroke-width=%222%22 stroke-linecap=%22round%22 stroke-linejoin=%22round%22><path d=%22m6 9 6 6 6-6%22/></svg>');">
                        ...
                        <div class="space-y-1.5 md:col-span-2">
                            <label class="text-xs font-bold uppercase tracking-widest text-gray-400" x-text="getServiceSpecificLabel()"></label>
                            <textarea x-model="formData.additionalDetails" :placeholder="getServiceSpecificPlaceholder()" class="w-full bg-gray-100 rounded-xl md:rounded-2xl py-4 md:py-5 px-5 md:px-6 text-brand-black font-semibold focus:ring-2 focus:ring-primary focus:bg-white border-none text-base md:text-lg min-h-[120px] md:min-h-[150px]"></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div x-show="step === 4" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-x-8" x-transition:enter-end="opacity-100 translate-x-0">
                    <h2 class="text-3xl md:text-5xl font-heading text-brand-black mb-8 md:mb-12 text-center uppercase tracking-tight">Review Inquiry</h2>
                ...
                <div x-show="step === 5" class="flex flex-col items-center text-center relative z-10 w-full" x-transition:enter="transition ease-out duration-500" x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100">
                    ...
                    <h2 class="text-3xl md:text-6xl font-heading text-white mb-4 md:mb-6 uppercase tracking-tight leading-none">Thank You</h2>
