    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="flex flex-col md:flex-row md:items-end justify-between mb-6 md:mb-12 gap-2 md:gap-6">
            ...
            <div class="flex items-center gap-4">
                <button class="md:w-fit w-full flex items-center gap-2 px-6 py-3 border border-gray-200 rounded-full text-sm font-bold text-gray-500 hover:bg-gray-50 transition duration-300">
                    <span>Sort</span>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
            ...
            {{-- Row 2 (Repeating images for placeholder as per typical property sites) --}}
            <x-shared.property-card
                image="{{ asset('brand-assets/4 Properties Page/Property image 1.png') }}"
        ...
        <div class="text-center">
            <button class="w-full bg-primary text-brand-black rounded-full py-4 px-12 font-bold text-xs uppercase tracking-widest hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 shadow-md">
                LOAD MORE
            </button>
        </div>
    </div>
