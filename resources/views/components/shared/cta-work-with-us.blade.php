{{-- [Component: shared/cta-work-with-us] "Work With Us" CTA band used on team/about pages --}}
<section id="cta-work-with-us" class="relative pt-8 pb-0">
            ...
            <div class="absolute inset-y-0 left-[35%] -translate-x-1/2 w-[40%] bg-gradient-to-l from-[#202020] to-transparent z-0"></div>
                ...
                <div class="p-6 md:p-16 text-white relative z-10 flex flex-col justify-between">
                    <div class="gap-2 md:gap-4">
                        <div class="badge-yellow w-fit">Work With Us</div>
                        <h2 class="text-4xl md:text-5xl font-heading mb-2 md:mb-6 uppercase">Need Professional Property Services?</h2>
                        <p class="text-gray-300 text-lg mb-10 max-w-lg">
                            Get in touch with our team for reliable and professional real estate support.
                        </p>
                    </div>
